                        ...
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                ...
                                <a href="print_membership_card.php?id=<?php echo $memberId; ?>" target="_blank" class="btn btn-tool">
                                    <i class="fas fa-external-link-alt"></i> Thẻ Nhân Viên
                                </a>
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-5">
                                    <p><strong>Mã Nhân Viên:</strong> <?php echo $memberDetails['membership_number']; ?></p>
                                    <p><strong>Họ Tên:</strong> <?php echo $memberDetails['fullname']; ?></p>
                                    <p><strong>Ngày Sinh:</strong> <?php echo $memberDetails['dob']; ?></p>
                                    <p><strong>Giới Tính:</strong> <?php echo $memberDetails['gender']; ?></p>
                                    <p><strong>Phone:</strong> <?php echo $memberDetails['contact_number']; ?></p>
                                    <p><strong>Email:</strong> <?php echo $memberDetails['email']; ?></p>
                                </div>
                                <div class="col-md-5">
                                    <p><strong>Địa Chỉ:</strong> <?php echo $memberDetails['address']; ?></p>
                                    <p><strong>Quốc Tịch:</strong> <?php echo $memberDetails['country']; ?></p>
                                    <p><strong>Mã Bưu Chính:</strong> <?php echo $memberDetails['postcode']; ?></p>
                                    <p><strong>Nghề Ngiệp:</strong> <?php echo $memberDetails['occupation']; ?></p>
                                    <p><strong>Phòng:</strong> <?php echo $memberDetails['membership_type_name']; ?></p>
                                    <p><strong>Trạng Thái:</strong> <?php echo $membershipStatus; ?></p>
                                </div>
                                <div class="col-md-2">
                                <?php
                                ...
                                <a href="print_membership_card.php?id=<?php echo $memberId; ?>" target="_blank" class="print-button"><button class="btn btn-info"><i class="fas fa-id-card"></i> Thẻ Nhân Viên</button></a>
