                    ...
                    <div class="col-md-12">
                        <div class="card card-primary">
                            <div class="card-header">
                                <h3 class="card-title"><i class="fas fa-cogs"></i> Cài Đặt</h3>
                            </div>
                            ...
                            <form method="post" action="" enctype="multipart/form-data">
                                <div class="card-body">
                                    ...
                                    <button type="submit" name="updateSettings" class="btn btn-primary">Cập Nhật</button>
                                </div>
                            </form>
                            ...
                            <form method="post" action="">
                                <div class="card-body">
                                    ...
                                    <button type="submit" name="changePassword" class="btn btn-primary">Thay Đổi Mật Khẩu </button>
                                </div>
                            </form>
