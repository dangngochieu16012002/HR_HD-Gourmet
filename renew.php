                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            <div class="card-header">
                                <h3 class="card-title"><i class="fas fa-keyboard"></i>Mẫu Gia Hạn Hợp Đồng</h3>
                            </div>
                            <!-- /.card-header -->
                            ...
                            <input type="hidden" name="member_id" value="<?php echo $id; ?>">
                                <div class="card-body">
                                    ...
                                    <input type="text" class="form-control" id="fullname" name="fullname"
                                        ...
                                        <div class="col-sm-6">
                                            <label for="dob">Mã Nhân Viên</label>
                                    ...
                                    <select class="form-control" id="membershipType" name="membershipType" required>
                                        ...
                                        <div class="col-sm-6">
                                        <label for="extendate">Gia Hạn Đến</label>
                                    ...
                                    <div class="row mt-3">
                                    <div class="col-sm-6">
                                        <label for="totalAmount">Lương</label>
