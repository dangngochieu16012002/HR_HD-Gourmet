 ...
 <?php include('includes/sidebar.php');?>
  ...
  <?php include('includes/pagetitle.php');?>
      ...
      <div class="container-fluid">
        ...
        <div class="row">
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                <span class="info-box-text">Sắp Hết Hợp Đồng</span>
        ...
        <div class="col-12 col-sm-6 col-md-3">
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                <span class="info-box-text">Thành Viên Hết Hợp Đồng</span>
        ...
        <div class="row">
          ...
          <div class="card">
            ...
            <h3 class="card-title">Thành Viên Mới Tham Gia</h3>
    ...
    <div class="card-body p-0">
        <ul class="products-list product-list-in-card pl-2 pr-2">
            ...
            while ($row = $recentMembersResult->fetch_assoc()) {
                ...
                echo 'Mã Thành Viên: ' . ($row['membership_number']); 
                echo '</span>';
                echo '</div>';
                echo '</li>';
            }
    ...
    <div class="card-footer text-center">
        <a href="manage_members.php" class="uppercase">Xem Thêm</a>
    </div>
    <!-- /.card-footer -->
</div>
